...
const ReporteMedidas = () => {
    ...
    const cargarHistorial = async () => {
        try {
            const response = await fetch(`${API_URL}/api/medida/usuario/${idUsuario}`);
            if (response.ok) {
    ...
    const handleDescargarPDF = async () => {
        try {
            ...
            const url = `${API_URL}/api/medida/usuario/${idUsuario}/reporte/pdf${params.toString() ? `?${params}` : ''}`;
            ...
            a.href = downloadUrl;
            a.download = `reporte_avance_${new Date().toISOString().split('T')[0]}.pdf`;
                ...
                <div className="row g-3 align-items-end small">
                    ...
                    <div className="col-12 col-sm-4">
                        <button
                            ...
                            disabled={medidasFiltradas.length === 0 || descargando}
                        >
